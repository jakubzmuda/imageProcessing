...
public class Lab3 {
    ...
    public void smoothing() {
        ...
        VBox masks = buildMasksForSmoothing();
        ...
        doIt.setOnAction((event) -> {
            Image newImage = new ImageOperations().applyMask(image, selectedMask, selectedBorderOperationStrategy);
    ...
    private VBox buildMasksForSmoothing() {
        Mask mask1 = new Mask(0, 1, 0, 1, 4, 1, 0, 1, 0);
        Button chooseMask1Button = new Button("Wybierz");
        chooseMask1Button.setOnAction(e -> {
            Image newImage = new ImageOperations().applyMask(image, mask1, this.selectedBorderOperationStrategy);
            updateImageAndHistogram(newImage);
        ...
        chooseMask2Button.setOnAction(e -> {
            Image newImage = new ImageOperations().applyMask(image, mask2, this.selectedBorderOperationStrategy);
            updateImageAndHistogram(newImage);
        ...
        chooseMask3Button.setOnAction(e -> {
            Image newImage = new ImageOperations().applyMask(image, mask3, this.selectedBorderOperationStrategy);
            updateImageAndHistogram(newImage);
        ...
        chooseMask4Button.setOnAction(e -> {
            Image newImage = new ImageOperations().applyMask(image, mask4, this.selectedBorderOperationStrategy);
            updateImageAndHistogram(newImage);
        ...
        chooseMask5Button.setOnAction(e -> {
            Image newImage = new ImageOperations().applyMask(image, mask5, this.selectedBorderOperationStrategy);
            updateImageAndHistogram(newImage);
    ...
    private VBox buildMasksForSharpening() {
        Mask mask1 = new Mask(0, -1, 0, -1, 4, -1, 0, -1, 0);
        Button chooseMask1Button = new Button("Wybierz");
        chooseMask1Button.setOnAction(e -> {
            Image newImage = new ImageOperations().applyMask(image, mask1, this.selectedBorderOperationStrategy);
        ...
        Mask mask2 = new Mask(-1, -1, -1, -1, 8, -1, -1, -1, -1);
        Button chooseMask2Button = new Button("Wybierz");
        chooseMask2Button.setOnAction(e -> {
            Image newImage = new ImageOperations().applyMask(image, mask2, this.selectedBorderOperationStrategy);
            updateImageAndHistogram(newImage);
        ...
        Mask mask4 = new Mask(-1, -1, -1, -1, 9, -1, -1, -1, -1);
        Button chooseMask4Button = new Button("Wybierz");
        VBox mask4Box = new VBox(mask4.asInteractiveTable(), chooseMask4Button);
        chooseMask4Button.setOnAction(e -> {
            Image newImage = new ImageOperations().applyMask(image, mask4, this.selectedBorderOperationStrategy);
        ...
        Mask mask5 = new Mask(0, -1, 0, -1, 5, -1, 0, -1, 0);
        Button chooseMask5Button = new Button("Wybierz");
        VBox mask5Box = new VBox(mask5.asInteractiveTable(), chooseMask5Button);
        chooseMask5Button.setOnAction(e -> {
            Image newImage = new ImageOperations().applyMask(image, mask5, this.selectedBorderOperationStrategy);
